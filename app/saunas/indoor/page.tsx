            ...
            <div className="mx-auto w-full max-w-6xl px-6 py-12">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-4 max-w-2xl text-lg text-neutral-600">
                        Discover our indoor sauna collection, perfect for home installation and year-round wellness.
                    </p>
                </div>

                {/* Category Dropdown */}
                <SaunaCategoryDropdown currentCategory="indoor" />

                {/* Category Sections */}
                <div className="space-y-12">
                    {/* Hot Tubs & Cold Plunge */}
                    {products.filter((p) => p.type === "indoor").length > 0 && (
                        <section>
